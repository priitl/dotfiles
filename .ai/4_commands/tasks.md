...
1. Determine feature context:
   ...
   - Derive: FEATURE_DIR = `specs/[branch-name]/`
   - Check which documents exist in FEATURE_DIR (plan.md required, others optional)
...
3. Generate tasks following the template:
   - Use `.ai/2_templates/tasks-template.md` as the base
