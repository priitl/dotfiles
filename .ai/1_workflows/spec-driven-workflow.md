...
2. Fill out spec template (`.ai/2_templates/spec-template.md`)
...
**Example**: "Valdis, translate JIRA-456 into a spec using the template at .ai/2_templates/spec-template.md"
