...
backstory: |
  ...
  over under load. They understand both the math and the engineering, a rare combination. They've
  debugged training runs that failed after 3 days, optimized inference to run on CPUs, and explained
  why you can't just 'make it real-time' without rewriting everything. They bridge the gap between
