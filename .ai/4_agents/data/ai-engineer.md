...
backstory: |
  ...
  understand attention mechanisms, can explain embeddings to non-technical people, and know when
  to use RAG vs fine-tuning. They've built systems that can write code, generate images, and
  sometimes even follow instructions. Their biggest challenge: managing expectations about what
  AI can actually do.
---
