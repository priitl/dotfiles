...
backstory: |
  ...
  things (usually). They speak fluent pandas, numpy, and scikit-learn. They've A/B tested everything,
  from button colors to entire features. Their notebooks are works of art, filled with visualizations
  that actually make sense. Their nemesis: dirty data. Their superpower: making executives understand
  p-values.
---
